...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setVersion('1.0')
    .addTag('system', 'Rendszer és kompatibilitási végpontok')
    .addTag('auth', 'Autentikációs végpontok')
    .addTag('users', 'Felhasználó kezelés')
    .addTag('games', 'játékek kezelése')
    .addTag('comments', 'Kommentek kezelése')
    .addTag('lists', 'Játéklisták kezelése')
    .addTag('devlogs', 'Fejlesztői naplók kezelése')
    .addTag('ai', 'AI alapú keresési végpontok')
